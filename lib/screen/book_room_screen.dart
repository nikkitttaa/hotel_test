      ...
      body: FutureBuilder<BookRoom>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            final fullPrice = bookRoom.tourPrice +
                bookRoom.serviceCharge +
                bookRoom.fuelCharge;
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            RatingContainer(
                                rating: bookRoom.horating,
                                ratingName: bookRoom.ratingName)
                          ],
                        ),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        InfoBook(
                            count: bookRoom.arrivalCountry,
                            text: 'Страна, город'),
                        InfoBook(
                            count:
                                "${bookRoom.tourDateStart}-${bookRoom.tourDateStop}",
                            text: 'Даты'),
                        InfoBook(
                            count: bookRoom.numberOfNights.toString(),
                            text: 'Кол-во ночей'),
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      ...
                      Container(
                        ...
                        height: 60,
                        decoration: BoxDecoration(
                          color: const Color.fromARGB(1000, 246, 246, 249),
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                color:
                                    const Color.fromARGB(1000, 13, 114, 255)),
                            child: IconButton(
                                onPressed: () {
                                  setState(() {
                                    count++;
                                    containers.add(ExpandableContainer(
                                        countTourist: count,
                                        firstNameController:
                                            firstNameController,
                                        lastNameController: lastNameController,
                          ...
                          child: TextButton(
                            onPressed: () {
                              if (phoneNumberController.text.isEmpty ||
                                  ...
                                  passportNumController.text.isEmpty ||
                                  passportValidityPerController.text.isEmpty ||
                                  email.value == false) {
                            ...
                            child: Text(
                              'Оплатить ${NumberFormat('#,##0').format(fullPrice).replaceAll(",", " ")} ₽',
                              style: const TextStyle(
