          ...
          Column(
            children: [
              Container(
                ...
                decoration: const BoxDecoration(shape: BoxShape.circle , color: Color.fromARGB(1000, 246, 246, 249)),
              ...
              Padding(
                ...
                child: Text('Подтверждение заказа №${randomNumber.toString()} может занять некоторое время (от 1 часа до суток). Как только мы получим ответ от туроператора, вам на почту придет уведомление.', 
                  style: const TextStyle(fontSize: 16, color: Color.fromARGB(1000, 130, 135, 150)), textAlign: TextAlign.center,),
              )
            ],
          ),
          SizedBox(
                ...
                children: [
                  ...
                  width: MediaQuery.sizeOf(context).width/1.05,
                    ...
                    child: TextButton(onPressed: (){
                      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => const HotelScreen()), (route) => false);
                    }, 
                    style: const ButtonStyle(backgroundColor: MaterialStatePropertyAll(Color.fromARGB(1000, 13, 114, 255))),
                      child: const Text('Супер!', style: TextStyle(color: Colors.white, fontSize: 16),),),
                ),
              ],
            ),
          ), 
